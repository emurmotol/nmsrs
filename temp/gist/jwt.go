...
const (
	privKeyPath = ".ssh/app.rsa"     // openssl genrsa -out app.rsa keysize
	pubKeyPath  = ".ssh/app.rsa.pub" // openssl rsa -in app.rsa -pubout > app.rsa.pub
)
...
func authHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		log.Printf("Token Signing error:117: %v\n", err)
		return
	}
...
func restrictedHandler(w http.ResponseWriter, r *http.Request) {
	...
	case err != nil:
		...
		log.Printf("Cookie parse error:147: %v\n", err)
		return
	}
	...
	case *jwt.ValidationError: // something was wrong during the validation
		...
		default:
			...
			log.Printf("ValidationError error:194: %+v\n", vErr.Errors)
			return
		}
	...
	default: // something else went wrong
		w.WriteHeader(http.StatusInternalServerError)
		fmt.Fprintln(w, "Error while Parsing Token!")
		log.Printf("Token parse error:201: %v\n", err)
		return
	}
